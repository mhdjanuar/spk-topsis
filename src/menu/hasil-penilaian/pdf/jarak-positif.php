<?php
    ...
    $pdf->SetTitle('Data Tabel Jarak Positif');
    ...
    $html = '
    <div>
        <h1 align="center">Laporan Hasil Jarak Positif</h1>
        <table border="1" cellpadding="4">
            ...
            foreach($data as $nama => $krit) {
                ...
                $html .= '<td>'.round(sqrt($dplus[$i-1]), 4).'</td>';
                $html .= '</tr>';
            }
    ...
    $pdf->Output('data-jarak-positif.pdf', 'I');
?>