<?php
    ...
    $pdf->SetTitle('Data Tabel Bobot Ternormalisasi');
    ...
    $html = '
    <div>
        <h1 align="center">Laporan Hasil Bobot Ternormalisasi</h1>
                ...
                $html .= '<tr>
                        ...
                        foreach($kriteria as $k){
                            if (isset($krit[$k]) && isset($nilai_kuadrat[$k]) && isset($bobot[$k])) {
                                ...
                                $html .= '<td align="center">'.$y[$k][$i-1].'</td>';
                            } else {
    ...
    $pdf->Output('data-bobot-ternormalisasi.pdf', 'I');
?>