<?php
    ...
    $pdf->SetTitle('Data Tabel Evaluasi Matrix');
    ...
    $html = '
    <div>
        <h1 align="center">Laporan Hasil Evaluasi Matriks</h1>
    ...
    $html .= '</thead>
            ...
            foreach($data as $nama => $krit) {
                $html .= '<tr>
                        ...
                        <td>'.$nama.'</td>';
                        foreach($kriteria as $k){
                            $html .= '<td align="center">' . (isset($krit[$k]) ? $krit[$k] : '-') . '</td>';
                        }
                $html .= '</tr>';
            }
    ...
    $pdf->Output('data-evaluasi.pdf', 'I');
?>