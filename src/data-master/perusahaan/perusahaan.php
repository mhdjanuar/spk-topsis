    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="<?php echo $base; ?>index.php" class="brand-link">
          ...
          <span class="brand-text font-weight-light">LatarOutdoor</span>
        </a>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title float-right">
                  <a href="<?php echo $base; ?>src/data-master/perusahaan/download-pdf.php" class="btn btn-success">
                    <i class="nav-icon fas fa-save"></i> Cetak Tabel
                  </a>
                  <a href="<?php echo $base; ?>src/data-master/perusahaan/formtambah.php" class="btn btn-primary">
                    <i class="nav-icon fas fa-plus"></i> Tambah Perusahaan
                  </a>
                </h3>
              </div>
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <a href="<?php echo $base; ?>src/data-master/perusahaan/formedit.php?id_perusahaan=<?php echo $row['id_perusahaan'] ?>">
                          <i class="fa fa-edit fa-fw"></i>
                        </a>
                      </td>
                      <td align="center">
                        <a href="<?php echo $base; ?>src/data-master/perusahaan/fungsihapus.php?id_perusahaan=<?php echo $row['id_perusahaan'] ?>">
